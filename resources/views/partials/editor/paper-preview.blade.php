...
<div class="col-span-12 lg:col-span-7 flex flex-col items-center lg:min-h-0 lg:overflow-y-auto custom-scrollbar pb-8">
    ...
    <div class="document-canvas p-6 md:p-10 rounded-2xl border border-parchment-300/80 dark:border-slate-warm-800 w-full flex flex-col items-center shadow-inner relative"
        ...
        <div
            class="w-full max-w-[595px] flex items-center justify-between mb-3 text-xs font-mono text-slate-warm-500 dark:text-parchment-400">
        ...
        <div class="paper-sheet paper-a4 paper-margins animate-fade-slide-up mb-8 text-ink-900 font-newsreader">
            ...
            <div class="text-center mb-6">
                <h3 class="font-serif font-bold text-base uppercase underline tracking-wider text-ink-900">KEPUTUSAN
                    DIREKSI</h3>
            ...
            <div class="mb-5 space-y-3 text-sm leading-relaxed">
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-1 sm:gap-2">
                    <span
                        class="sm:col-span-3 font-semibold font-sans text-xs uppercase tracking-wide">Menimbang:</span>
                    <div class="sm:col-span-9 whitespace-pre-line text-xs font-newsreader text-justify"
                        x-text="menimbang"></div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-12 gap-1 sm:gap-2">
                    <span
                        class="sm:col-span-3 font-semibold font-sans text-xs uppercase tracking-wide">Mengingat:</span>
                    <div class="sm:col-span-9 whitespace-pre-line text-xs font-newsreader text-justify"
                        x-text="mengingat"></div>
                </div>
            </div>
            ...
            <div class="text-center my-4">
                <span
                    class="font-serif font-bold text-xs uppercase tracking-widest px-4 py-1 border-y border-ink-900 inline-block">MEMUTUSKAN</span>
            </div>
            ...
            <div
                class="absolute bottom-4 left-4 sm:left-12 right-4 sm:right-12 flex items-center justify-between text-[10px] font-mono text-slate-warm-400 border-t border-parchment-200 pt-2">
        ...
        <div class="paper-sheet paper-a4 paper-margins animate-fade-slide-up text-ink-900 font-newsreader relative">
            ...
            <div class="mt-8 sm:mt-12 grid grid-cols-1 sm:grid-cols-12 gap-4 items-end">
                ...
                <div class="sm:col-span-6 space-y-3">
                    ...
                    <div
                        class="flex items-center gap-2.5 p-2 rounded-lg border border-parchment-300 bg-parchment-50 max-w-[220px]">
                        <!-- Simulated QR Code -->
                ...
                <div class="sm:col-span-6 text-center font-sans relative">
                    ...
                    <div class="my-3 min-h-[80px] sm:min-h-[90px] flex items-center justify-center relative">
                        ...
                        <template x-if="selectedMaterai === 'stempel_basah'">
                            <div
                                class="w-16 h-16 border-2 border-seal-700 rounded-full absolute left-3 top-0 flex items-center justify-center text-seal-700 font-bold text-[9px] uppercase tracking-tighter opacity-85 rotate-[-12deg]">
                                PT NCM TBK<br />SEKRETARIAT
                            </div>
                        </template>

                        <!-- ACTUAL SIGNATURE IMAGE FROM VAULT -->
                        <template x-if="hasSignature && selectedSignatureUrl">
                            <div class="relative z-10">
                                <img :src="selectedSignatureUrl"
                                    class="max-h-[70px] max-w-[180px] object-contain mx-auto" alt="Tanda tangan">
                            </div>
                        </template>
                        <template x-if="hasSignature && !selectedSignatureUrl">
                            <div
                                class="relative z-10 text-[10px] text-slate-warm-400 italic border border-dashed border-parchment-300 rounded px-3 py-2">
                                Pilih tanda tangan lewat tombol "Tempel TTD"
                            </div>
                        </template>
                    </div>
            ...
            <div
                class="absolute bottom-4 left-12 right-12 flex items-center justify-between text-[10px] font-mono text-slate-warm-400 border-t border-parchment-200 pt-2">
