...
<div class="min-h-screen flex items-center justify-center p-6 bg-parchment-100 dark:bg-slate-warm-950 relative overflow-hidden">
    ...
    <div class="w-full max-w-[400px] relative z-10">
        ...
        @if (request()->has('logged_out'))
            <div class="mb-6 p-3 rounded-lg border border-parchment-300 bg-parchment-50 text-ink-800 text-xs font-medium flex items-center gap-2 dark:bg-slate-warm-900 dark:border-slate-warm-700 dark:text-parchment-200">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 16 12 12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>
...
>>>>>>> b895488bd17b0375d2c9a5e1f97bb8bec3dcc502
                ...
                <div>
                    <div class="flex items-center justify-between mb-1.5">
                        <label for="signin-password" class="block text-xs font-semibold text-ink-900 dark:text-parchment-200">Kata Sandi</label>
                ...
                <button type="submit" class="w-full rounded-lg bg-ink-900 text-parchment-50 py-3 text-sm font-semibold shadow-md hover:bg-ink-800 active:scale-[0.98] transition-all dark:bg-parchment-100 dark:text-ink-900 dark:hover:bg-parchment-200">
                    Masuk
                </button>
            </form>
        </div>
        ...
        <p class="text-center text-xs text-slate-warm-500 dark:text-parchment-400 mt-6">
            Belum punya akun?
            <a href="/signup" class="font-semibold text-ink-900 hover:underline dark:text-parchment-200">Buat akun baru</a>
        </p>
