                ...
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        <label for="signup-fname"
                            class="block text-xs font-semibold text-ink-900 dark:text-parchment-200 mb-1.5">Nama
                            Depan</label>
                        <input id="signup-fname" name="fname" type="text" required placeholder="Aris"
...
>>>>>>> b895488bd17b0375d2c9a5e1f97bb8bec3dcc502
                ...
                <div class="flex items-start gap-2.5 pt-1">
                    <input type="checkbox" required id="terms" checked
                        class="mt-0.5 rounded border-parchment-400 text-ink-900 focus:ring-ink-900/20 dark:border-slate-warm-600 dark:bg-slate-warm-700" />
                    <label for="terms"
                        class="text-xs text-slate-warm-600 dark:text-parchment-300 leading-relaxed select-none">
                        Saya setuju dengan <a href="#"
                            class="underline hover:text-ink-900 dark:hover:text-parchment-100">Ketentuan Layanan</a> dan
                        <a href="#" class="underline hover:text-ink-900 dark:hover:text-parchment-100">Kebijakan
                            Privasi</a>.
                    </label>
                </div>

                <button type="submit"
                    class="w-full rounded-lg bg-ink-900 text-parchment-50 py-3 text-sm font-semibold shadow-md hover:bg-ink-800 active:scale-[0.98] transition-all dark:bg-parchment-100 dark:text-ink-900 dark:hover:bg-parchment-200 mt-1">
                    Buat Akun
                </button>
            </form>
        </div>
