...
<head>
    ...
    <title>{{ $title ?? 'Papercraft Studio' }} | Autentikasi Dokumen</title>
...
<body class="bg-parchment-50 font-jakarta text-ink-900 antialiased canvas-grain" x-data="{ 'loaded': true }">
