<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div class="flex items-center justify-between w-full gap-3 px-4 py-3 border-b border-parchment-200 dark:border-slate-warm-800 xl:justify-normal xl:border-b-0 xl:px-0">
            ...
            <div class="hidden sm:flex items-center gap-3 ml-2 lg:ml-4 grow max-w-xl">
                <div class="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-parchment-300 bg-white shadow-theme-xs dark:bg-slate-warm-800 dark:border-slate-warm-700 grow">
                    <svg class="text-bronze-600 dark:text-bronze-400 shrink-0" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <span class="text-[10px] font-mono text-slate-warm-400 shrink-0 hidden md:inline" x-text="savedTime"></span>
                </div>
            </div>
            ...
            <div class="hidden xl:block ml-auto">
                <form @submit.prevent>
                    <div class="relative">
                        <span class="absolute -translate-y-1/2 pointer-events-none left-3.5 top-1/2 text-slate-warm-400">
